            ...
            ra = function (z, o) {
                ...
                function Va(a) {
                    ...
                    if (b && e) {
                        var f = [],
                                h = 0,
                                a = a.replace(/(<img)((?:\s+[^>]*?)?(?:\s+src="\s*([^"]+)\s*")(?: [^>]*)?)(\/?>)/ig, function (a, e, c, d, r) {
                ...
                var c = this,
                        ...
                        X = null,
                        O = 0,
                        g = c.settings = d.extend({}, ra.settings, o),
                        xa = g.plugins,
                        ya = [];
                    ...
                    q.find(".xheButton").hover(function (a) {
                        ...
                        if (ia) {
                            ...
                            if (1 < Math.abs(b) || 1 < Math.abs(c))
                                0 < b && 0 < c ? (b = Math.round(Math.atan(c / b) / 0.017453293), X = X ? (X + b) / 2 : b) : X = null, ia = {
                                    x: a.clientX,
                                    y: a.clientY
                                }
                        }
                ...
                this.processHTML = function (a,
                    ...
                    if ("write" === b) {
                        ...
                        a = a.replace(/(<(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*(\/?>)/g, function (a, b, e, c, d) {
                            var e = e.toLowerCase(),
                                    f, c = c.replace(/\s+_xhe_(?:src|href)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i, function (a,
                                            b) {
                                        f = b.match(/^(["']?)(.*)\1/)[2];
                                        return ""
                                    });
                ...
                this.showTable = function () {
                    ...
                    d("#xheSave", a).click(function () {
                        ...
                        var a = s.val(),
                                ...
                                w = u.val(),
                                z = r.val(),
                                d = "<table" + ("" !== d ? ' border="' + d + '"' : "") + ("" !== p ? ' width="' + p + '"' : "") + ("" !== q ? ' height="' +
                ...
                this.startUpload = function (a, b, e, f) {
                    ...
                    var n = [],
                            j = g.html5Upload,
                            l = j ? g.upMultiple : 1,
                            i, r = d('<div style="padding:22px 0;text-align:center;line-height:30px;">\u6587\u4ef6\u4e0a\u4f20\u4e2d\uff0c\u8bf7\u7a0d\u5019\u2026\u2026<br /></div>'),
