...
//        },
    ...
    submitHandler: function (form) {
        ...
        data.remark = $("#add_platform_form #remark").html();
//        if ((data.payment_method).indexOf("΢��") === -1 && data.tra_num === "") {
//            $("#add_platform_form #tra_num").prev(".fa").addClass("fa-warning");
//            $("#add_platform_form #tra_num").parent(".input-icon").parent(".col-md-3").addClass("has-error");
//            return;
//        }
        data.action = 1;
