...
//        },
    ...
    submitHandler: function (form) {
        ...
        if ((data.payment_method).indexOf("΢��") === -1 && data.tra_num === "") {
            $("#add_physica_form #tra_num").prev(".fa").addClass("fa-warning");
            $("#add_physica_form #tra_num").parent(".input-icon").parent(".col-md-3").addClass("has-error");
            return;
        }
        data.action = 1;
        data.remark = $("#add_physica_form #remark").html();
        data.agent_category_selected = $("#agent_category_selected").text();
