...
var CustomerStatisticsMonthViewModel = new function () {
    ...
    self_.listCustomerStatisticsMonth = function (data) {
        ...
        ycoa.ajaxLoadGet("/api/second_sale_soft/customer_statistics.php", data, function (results) {
   ...
   //导出EXCEL
    ...
    $("#btn_toexcel_primary").live("click", function () {
        ...
        if (start_time || end_time) {
            location.href = "/api/second_sale_soft/customer_statistics.php?start_time=" + start_time + "&end_time=" + end_time + "&action=12";
        }
    });
    //计算日期在列表显示
    var tmpDate = new Date();
    ...
    $("#customerStatisticsMonth").text(customerStatisticsMonthDate);
        ...
        ycoa.ajaxLoadGet("/api/second_sale_soft/customer_statistics.php", {action:13,time_unit:2,team:1}, function (result) {
            var html = "<ul>";
             html += "<li style='width:600px;'><span class='num'>排名</span><span class='presales' style='width:120px;'>姓名</span><span class='count'style='width:100px;'>业绩金额</span><span class='money'>换算金额</span><span class='money'>转化率</span><span class='money'>均价</span><span class='money'>晋升等级</span></li>";
            $.each(result, function (index, d) {
                ...
                html += "<li style='width:600px;'><span class='num' style='"+style+"'>" + (index + 1) + "</span><span class='presales' style='width:120px;'>" + (d.user_name) + "</span><span class='count'style='width:100px;'>" + (d.second_sales) + "</span><span class='money'>" + (d.proportion) + "</span><span class='money'>" + (d.conversion_rate) + "</span><span class='money'>" + (d.average_price) + "</span><span class='num' style='background-color:"+level_style[d.promotion_level]+"'>" + (d.promotion_level) + "</span></li>";
            });
            html += "</ul>";
...
//                var v = self.attr("var");
//                ycoa.ajaxLoadGet("/api/second_sale_soft/customer_statistics.php", {action: 13, time_unit:2,team:v}, function (result) {
//                    var html = "<ul>";
//                     html += "<li style='width:600px;'><span class='num'>排名</span><span class='presales' style='width:100px;'>姓名</span><span class='count'style='width:100px;'>业绩金额</span><span class='money'>换算金额</span><span class='money'>转化率</span><span class='money'>均价</span><span class='money'>晋升等级</span></li>";
//                    $.each(result, function (index, d) {
//                       
//                        html += "<li style='width:600px;'><span class='num'>" + (index + 1) + "</span><span class='presales' style='width:100px;'>" + (d.user_name) + "</span><span class='count'style='width:100px;'>" + (d.second_sales) + "</span><span class='money'>" + (d.proportion) + "</span><span class='money'>" + (d.conversion_rate) + "</span><span class='money'>" + (d.average_price) + "</span><span class='money'>" + (d.promotion_level) + "</span></li>";
//                    });
//                    html += "</ul>";
