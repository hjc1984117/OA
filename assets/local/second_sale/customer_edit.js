 var CustomerEditViewModel = new function () {
    ...
    self_.listCustomerEdit = function (data) {     
        ycoa.ajaxLoadGet("/api/second_sale/customer_edit.php", data, function (results) {
   ...
   self_.editCustomer = function(customerEdit)
   {
    ...
    self_.changeCustomerGroup=function(customerEdit)
    {
        ...
        if(customerEdit.group=='单人组')
        {
            ...
            ycoa.ajaxLoadGet("/api/second_sale/customer_edit.php?action=2&userid="+customerEdit.userid+"&team="+customerEdit.team,null,function (results) {
    ...
    self_.doSubmitOperateCustomer = function (customerEdit) {
        ...
        switch(self_.operationType)
        {
          ...
          case 3:
            ...
            ycoa.ajaxLoadPost("/api/second_sale/customer_edit.php", JSON.stringify(customerEdit), function (result) {
