...
function update_customerstatistics($db, $customer_id, $money, $action = 0, $date= 0,$ind_refund_rate = 0, $isupdate = 0) {
    ...
    $customerstatistics->set_query_fields(p_customerstatistics_soft::$field_id, p_customerstatistics_soft::$field_have_received);
    $customerstatistics->set_where_and(p_customerstatistics_soft::$field_group, SqlOperator::Equals, $customerrecord_res['group']);
    if($customerrecord_res['suserid']){       
       ...
       $customerstatistics->set_where_and(p_customerstatistics_soft::$field_user_id, SqlOperator::Equals, $customerrecord_res['userid']);
       $username = $customerrecord_res['username'];
    }
     $customerstatistics->set_where_and(p_customerstatistics_soft::$field_user_name, SqlOperator::Equals, $username);
     ...
     $customerstatistics_act = new p_customerstatistics_soft();
    ...
    switch ($action){
        ...
        case 0:
            ...
            if($count){
                ...
                $customerstatistics_act->set_where_and(p_customerstatistics_soft::$field_id, SqlOperator::Equals, $customerstatistics_res['id']);
