...
execute_action(HttpRequestMethod::Get, 1, function() {
    ...
    $sql = 'SELECT * FROM ((SELECT id,userid,username,`group`,team,category,group_members FROM p_customerrecord WHERE group_members!=userid and `group`=2)';
    $sql .= 'UNION ALL';
    $sql .= '(SELECT id,userid,username,`group`,team,category,group_members FROM p_customerrecord WHERE group_members=0 and `group`=1)) as u ';
...
execute_action(HttpRequestMethod::Get, 2, function() {   
    ...
    $customerrecord = new p_customerrecord();
    $customerrecord->set_where_and(p_customerrecord::$field_userid, SqlOperator::NotEquals, $userid);
    $customerrecord->set_where_and(p_customerrecord::$field_group, SqlOperator::Equals, 1);
    $customerrecord->set_where_and(p_customerrecord::$field_team, SqlOperator::Equals, $team[0]);
    $db = create_pdo();
...
execute_action(HttpRequestMethod::Post, 1, function() {
    ...
    $customerrecord->set_where_and(p_customerrecord::$field_userid, SqlOperator::Equals, $customerrecordData->userid);
    
    $groupmember = new p_customerrecord();
    ...
    $groupmember->set_where_and(p_customerrecord::$field_userid, SqlOperator::Equals, $customerrecordData->group_members);
...
execute_action(HttpRequestMethod::Post, 2, function() {
    ...
    $customerrecord_owner->set_where_and(p_customerrecord::$field_userid, SqlOperator::Equals, $customerrecordData->userid);
    ...
    $customerrecord_stuff->set_where_and(p_customerrecord::$field_userid, SqlOperator::Equals, $customerrecordData->group_members);
...
execute_action(HttpRequestMethod::Post, 3, function() {
    ...
    $customerstatistics->set_where_and(p_customerstatistics::$field_user_id,SqlOperator::Equals, $customerrecordData->userid); 
