...
$GLOBALS['/Models/p_customerstatistics_soft.php'] = 1;

use Models\Base\Model;

class p_customerstatistics_soft extends Model{
	...
	static function init_schema() {
		...
		self::$field_receive_amount = Model::define_field('receive_amount', 'int', 0);
		...
		self::$MODEL_SCHEMA = Model::build_schema('p_customerstatistics_soft', array(
			self::$field_id,
			self::$field_user_id,
...
p_customerstatistics_soft::init_schema();
