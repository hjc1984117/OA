...
$GLOBALS['/Models/p_refundapply_soft.php'] = 1;

use Models\Base\Model;

class p_refundapply_soft extends Model{
	...
	static function init_schema() {
		...
		self::$MODEL_SCHEMA = Model::build_schema('p_refundapply_soft', array(
			self::$field_id,
			self::$field_addtime,
...
p_refundapply_soft::init_schema();
