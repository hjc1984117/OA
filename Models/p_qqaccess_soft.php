...
$GLOBALS['/Models/p_qqaccess_soft.php'] = 1;

use Models\Base\Model;

class p_qqaccess_soft extends Model{
	...
	static function init_schema() {
		...
		self::$field_validation = Model::define_field('validation', 'string', 0);
		...
		self::$MODEL_SCHEMA = Model::build_schema('p_qqaccess_soft', array(
			self::$field_id,
			self::$field_addtime,
